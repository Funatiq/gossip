...
public:
        ...
        : external_context (false)
    {
        ...
        transfer_plan = default_scatter_plan(num_gpus_, main_gpu_);
          ...
          transfer_plan(transfer_plan_)
    {
        ...
        if(!transfer_plan.valid())
            verify_scatter_plan(transfer_plan);
        ...
        : external_context (false)
    {
        ...
        transfer_plan = default_scatter_plan(device_ids_.size(), main_gpu_);
          ...
          external_context (true)
    {
        ...
        transfer_plan = default_scatter_plan(get_num_devices(), main_gpu_);
