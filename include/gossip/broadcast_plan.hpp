...
namespace gossip {
 ...
 void verify_broadcast_plan(transfer_plan_t& plan) {
    bool valid = true;

    valid &= check(plan.main_gpu() != -1,
...
transfer_plan_t default_broadcast_plan(const gpu_id_t num_gpus, const gpu_id_t source) {
